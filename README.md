...
## Technical Aspects
The system is built using NestJS, leveraging its robust framework for creating RESTful APIs. Data persistence is managed using PostgreSQL, with the database connection established via a Docker container for consistency and ease of deployment.
